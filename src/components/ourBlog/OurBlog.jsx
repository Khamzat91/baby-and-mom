  ...
  return (
    <div className="our-blog">
      <div className="our-blog__image">
        <img src={scroll} alt="" className="our-blog__image-scroll" />
        <img src={chat} alt="" className="our-blog__image-chat" />
        <div className="our-blog__image-title">Наш блог</div>
        <div className="our-blog__image-btn">
          <Slider {...settings}>
{
    sliderCard.map((obj) => <div className="our-blog__slider">
        ...
        <div className="our-blog__slider-data">
           ...
           <div className="our-blog__slider-data__more">
            ...
            <div className="our-blog__slider-data__readArrow">{obj.readArrow}</div>
           </div>
        </div>
    </div>)
}
          ...
          Читать блог
          <BtnArrow className="our-blog__image-btnArrow" />
        </div>
      </div>
    </div>
  );
